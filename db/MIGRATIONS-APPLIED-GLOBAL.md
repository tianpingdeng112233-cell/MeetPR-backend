...
2026-09-23 只读复核（不是迁移/部署）：[run 35857998786](https://github.com/tianpingdeng112233-cell/MeetPR-backend/actions/runs/35857998786) 成功、deploy skipped。实际活动 api 仍为 `sha-7ce724538b385104efdea9e549ddad65657a7dc9`，PG17.11、账本0068；0070批次表/seq不存在，coach gate未配置。最新备份为2026-09-23 10:02:08 UTC，恢复未验证。候选 `1b9c6f5` 仅0070待应用，0069不在该ref。执行前须按[具体方案](../docs/w3-global-rollout-2026-09-23.md)重新核对并获授权，不沿用默认浮动ref盲跑。

| 日期(UTC)  | 动作                                                                                                                | 结果                                                                                    |
| ---------- | ------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| 2026-08-23 | deploy-global.yml 上线 `sha-7ce7245`(#268 web 换装 plan-web main@3366b46:#96 拼音搜索,无迁移)                       | Healthy;入口换 index-rn-QhpHI.js(与 CN 线同产物),/health 200;run 32652429117            |
