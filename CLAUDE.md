...
**045 部署（2026-09-16）**：backend #276 已合并，真实 RDS 0070 已应用，d0b919d 镜像全量部署通过；coach gate 已提交配置滚动，运行值核验和 web #101/#53 换装继续跟踪。执行下一次迁移、回退或三端验收前，读取 [本批部署记录](docs/deployment-045-web101-53-2026-09-16.md) 与 [staging 账本](db/MIGRATIONS-APPLIED.md)。APNS_ENV=sandbox，TestFlight production 投递仍待独立验收。
